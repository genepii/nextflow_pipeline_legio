...
echo "Adapters trimming : ${adapters}"
...
echo "BBWRAP MAPPING - decontamination (used if true)"
...
echo "DOWNSAMPLING (used if true)"
echo "Fraction : ${bbtools_downsampled}"
echo ""

echo "KRAKEN2 - taxonomic assignation (used if true)"
