...
- Set-up of the amplicon analysis pipeline using QIIME 2.
- Automation of the main stages of amplicon data processing.
- Management of sequence files and metadata.
- Generation of the QIIME 2 results required for downstream analyses.
- Organisation of artefacts and results within a dedicated directory structure.
