...
#                                                                              #
# Usage:  sbatch start_blast_amplicons.sh -s NGS-WEB_ID [options]              #
#                                                                              #
################################################################################

# Help screen
display_help() { 
    echo "Usage: sbatch start_blast_amplicons.sh -s NGS-WEB_ID [options]" >&2
    echo >&2
    echo >&2
...
usage() {
    echo "Usage: sbatch start_blast_amplicons.sh -s <YYYYMMDD> [options]"
    echo ""
    echo "Options:"
